...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SingleGame_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(3, 25, 8) // "slotBack"

    },
    "SingleGame\0computerMove\0\0slotBack"
};
...
void SingleGame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SingleGame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SingleGame::staticMetaObject = { {
    QMetaObject::SuperData::link<Board::staticMetaObject>(),
    qt_meta_stringdata_SingleGame.data,
    qt_meta_data_SingleGame,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SingleGame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SingleGame.stringdata0))
